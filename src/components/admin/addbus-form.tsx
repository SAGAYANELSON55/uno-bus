...
const AddbusForm = () => {
  ...
  console.log(enteredValues.departureTime);
      ...
      <form className={style.formContainer} onSubmit={addbusHandler}>
        <div className={style.control}>
          ...
          <input
            ...
            required
          />
          {nameIsInvalid && <p>*should not be empty and include only alpha</p>}
        </div>
        <div className={style.control}>
          ...
          <input
            ...
            onChange={(event) => handleInputChange("busNo", event.target.value)}
        ...
        <div className={style.action}>
          <button className={style.actions} type="submit">
            {loading ? "Adding" : "Add"}
          </button>
        </div>
      </form>
